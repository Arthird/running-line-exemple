...
**Next.js** is a next-generation React framework offering built-in support for:
...
I chose it because I plan to continue working with React and Next.js in the future.
...
**Tailwind CSS** is a utility-first CSS framework that enables rapid and flexible UI styling without writing custom CSS.
...
**Framer Motion** is a powerful yet simple animation library for React, providing:
...
**Next.js** — это React-фреймворк нового поколения, который предоставляет встроенную поддержку:

- серверного рендеринга (SSR) и статической генерации (SSG),
- маршрутизации на основе файловой системы,
- API-роутов,
...
**Tailwind CSS** — это утилитарный CSS-фреймворк, который позволяет быстро и гибко стилизовать интерфейсы без необходимости писать кастомные стили.

🔗 [Официальный сайт Tailwind CSS](https://tailwindcss.com)

---

### 🌀 [Framer Motion](https://www.framer.com/motion/)

**Framer Motion** — это мощная, но простая в использовании библиотека анимаций для React. Она обеспечивает:
